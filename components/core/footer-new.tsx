      ...
      <div className="max-w-6xl mx-auto px-8 lg:px-12 py-12 relative">
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-8">
          ...
          >
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/help" className="text-gray-600 hover:text-gray-900 transition-colors duration-200 text-sm">
                  Voice Input
                </Link>
              </li>
              <li>
        ...
        >
          ...
          <div className="flex items-center space-x-6 text-sm">
            <Link href="/privacy" className="text-gray-500 hover:text-gray-700 transition-colors duration-200">
              Privacy
            </Link>
            <Link href="/terms" className="text-gray-500 hover:text-gray-700 transition-colors duration-200">
              Terms
            </Link>
